...
sidebar:
  ...
  sections: 
    ...
    - name: Activités
      items:
        - Co-direction de la revue \textit{Rzine}
        - Membre du comité éditorial de la revue \textit{Cybergeo}
        - Organisation de 10 journées d'étude, 4 sessions de colloque international, 3 summer school
        - +80 conférences, dont 27 invitations
        - 19 articles, chapitres d'ouvrage \& actes de colloque
        - Encadrement de 4 masters \& 1 thèse en archéologie
        - Responsable de 2 séminaires de recherche (291h)
        - Enseignement de 381h en géographie, 70h en archéologie
    - name: Méthodologie
      items:
        - BDD relationnelle
        - Statistiques
